...
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.DNSLookupOptions
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.DNSLookupResults
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.DNSLookupsOptions
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.DescribeDomainOptions
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.DescribeMailServerDomainResult
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.EmailVerificationResult
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.IPAddressResult
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.VerifyEmailAddressOptions
...
class MailServerControllerApi(baseUrl: String) {
   ...
   */
  def getDnsLookups(apiKey: String)(dNSLookupsOptions: DNSLookupsOptions
): Request[Either[ResponseError[Exception], DNSLookupResults], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/mail-server/describe/dns-lookups")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .body(dNSLookupsOptions)
      .response(asJson[DNSLookupResults])
