...
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.AliasDto
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.AliasThreadProjection
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.CreateAliasOptions
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.PageAlias
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.PageAliasThreadProjection
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.PageEmailProjection
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.ReplyToAliasEmailOptions
...
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.UpdateAliasOptions
...
class AliasControllerApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : PageAliasThreadProjection (OK)
   * 
   * Available security schemes:
   *   API_KEY (apiKey)
   * 
...
): Request[Either[ResponseError[Exception], PageAliasThreadProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/aliases/${aliasId}/threads?page=${ page }&size=${ size }&sort=${ sort }&since=${ since }&before=${ before }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[PageAliasThreadProjection])
   ...
   * 
   * Expected answers:
   *   code 200 : AliasThreadProjection (OK)
   * 
   * Available security schemes:
   *   API_KEY (apiKey)
   * 
...
): Request[Either[ResponseError[Exception], AliasThreadProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/aliases/threads/${threadId}")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[AliasThreadProjection])
