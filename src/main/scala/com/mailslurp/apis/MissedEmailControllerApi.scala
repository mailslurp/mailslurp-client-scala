...
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.MissedEmail
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.PageMissedEmailProjection
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.PageUnknownMissedEmailProjection
...
class MissedEmailControllerApi(baseUrl: String) {
   ...
   * @param sort Optional createdAt sort direction ASC or DESC
   */
  def getAllUnknownMissedEmails(apiKey: String)(inboxId: Option[UUID] = None, page: Option[Int] = None, searchFilter: Option[String] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageUnknownMissedEmailProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/missed-emails/unknown?inboxId=${ inboxId }&page=${ page }&searchFilter=${ searchFilter }&size=${ size }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
