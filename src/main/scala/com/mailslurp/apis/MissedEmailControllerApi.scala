...
import com.mailslurp.modelspackageVersion&#x3D;15.19.17.MissedEmailDto
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.19.17.PageMissedEmailProjection
import com.mailslurp.modelspackageVersion&#x3D;15.19.17.PageUnknownMissedEmailProjection
...
): Request[Either[ResponseError[Exception], MissedEmailDto], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/missed-emails/${missedEmailId}")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[MissedEmailDto])
