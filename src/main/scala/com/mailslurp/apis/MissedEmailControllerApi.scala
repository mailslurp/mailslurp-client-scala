...
import com.mailslurp.modelspackageVersion&#x3D;12.3.333.MissedEmail
import com.mailslurp.modelspackageVersion&#x3D;12.3.333.PageMissedEmailProjection
...
class MissedEmailControllerApi(baseUrl: String) {
   ...
   */
  def getAllMissedEmails(apiKey: String)(page: Option[Int] = None, searchFilter: Option[String] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageMissedEmailProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/missed-emails?page=${ page }&searchFilter=${ searchFilter }&size=${ size }&sort=${ sort }")
