...
import com.mailslurp.modelspackageVersion&#x3D;15.13.1.CreateEmergencyAddressOptions
import com.mailslurp.modelspackageVersion&#x3D;15.13.1.EmergencyAddress
import com.mailslurp.modelspackageVersion&#x3D;15.13.1.EmergencyAddressDto
import com.mailslurp.modelspackageVersion&#x3D;15.13.1.EmptyResponseDto
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.13.1.PagePhoneNumberProjection
import com.mailslurp.modelspackageVersion&#x3D;15.13.1.PhoneNumberDto
import com.mailslurp.modelspackageVersion&#x3D;15.13.1.PhonePlanDto
import com.mailslurp.modelspackageVersion&#x3D;15.13.1.TestPhoneNumberOptions
...
class PhoneControllerApi(baseUrl: String) {
   ...
   */
  def getPhoneNumbers(apiKey: String)(page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, since: Option[OffsetDateTime] = None, before: Option[OffsetDateTime] = None
): Request[Either[ResponseError[Exception], PagePhoneNumberProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/phone/numbers?page=${ page }&size=${ size }&sort=${ sort }&since=${ since }&before=${ before }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   */
  def testPhoneNumberSendSms(apiKey: String)(phoneNumberId: UUID, testPhoneNumberOptions: TestPhoneNumberOptions
): Request[Either[ResponseError[Exception], Unit], Nothing] =
    basicRequest
