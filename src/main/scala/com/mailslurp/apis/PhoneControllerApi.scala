...
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.ConsentStatusDto
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.CreateEmergencyAddressOptions
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.CreatePhoneNumberOptions
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.EmergencyAddress
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.EmergencyAddressDto
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.EmptyResponseDto
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.PagePhoneMessageThreadItemProjection
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.PagePhoneMessageThreadProjection
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.PagePhoneNumberProjection
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.PageSentSmsProjection
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.PageSmsProjection
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.PhoneNumberDto
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.PhoneNumberValidationDto
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.PhonePlanAvailability
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.PhonePlanDto
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.SentSmsDto
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.SetPhoneFavouritedOptions
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.SmsSendOptions
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.TestPhoneNumberOptions
import java.util.UUID
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.UpdatePhoneNumberOptions
import com.mailslurp.modelspackageVersion&#x3D;15.21.1.ValidatePhoneNumberOptions
...
class PhoneControllerApi(baseUrl: String) {
   ...
   *   API_KEY (apiKey)
   */
  def getPhoneNumberByName(apiKey: String)(
): Request[Either[ResponseError[Exception], PhoneNumberDto], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/phone/numbers/by-name")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[PhoneNumberDto])
   ...
   *   API_KEY (apiKey)
   */
  def getPhoneNumberByPhoneNumber(apiKey: String)(
): Request[Either[ResponseError[Exception], PhoneNumberDto], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/phone/numbers/by-phone-number")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[PhoneNumberDto])
