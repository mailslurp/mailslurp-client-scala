...
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.MatchOptions
import java.time.OffsetDateTime
import java.util.UUID
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.WaitForConditions
...
def apply(baseUrl: String = "http://localhost:8080") = new WaitForControllerApi(baseUrl)
}
