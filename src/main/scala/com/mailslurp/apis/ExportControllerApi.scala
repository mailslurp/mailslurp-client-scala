...
import com.mailslurp.modelspackageVersion&#x3D;15.0.5.ExportLink
import com.mailslurp.modelspackageVersion&#x3D;15.0.5.ExportOptions
...
def apply(baseUrl: String = "http://localhost:8080") = new ExportControllerApi(baseUrl)
}
