...
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.ExpirationDefaults
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.ExpiredInboxDto
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.PageExpiredInboxRecordProjection
...
def apply(baseUrl: String = "http://localhost:8080") = new ExpiredControllerApi(baseUrl)
}
...
class ExpiredControllerApi(baseUrl: String) {
   ...
   */
  def getExpiredInboxRecord(apiKey: String)(iDOfTheExpiredInboxRecordYouWantToRetrieveThisIsDifferentFromTheIDOfTheInboxYouAreInterestedInSeeOtherMethodsForGettingExpiredInboxRecordForAnInboxInboxId: UUID
): Request[Either[ResponseError[Exception], ExpiredInboxDto], Nothing] =
    basicRequest
