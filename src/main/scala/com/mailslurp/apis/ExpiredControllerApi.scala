...
import com.mailslurp.modelspackageVersion&#x3D;15.21.0.ExpirationDefaults
import com.mailslurp.modelspackageVersion&#x3D;15.21.0.ExpiredInboxDto
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.21.0.PageExpiredInboxRecordProjection
...
class ExpiredControllerApi(baseUrl: String) {
   ...
   */
  def getExpiredInboxes(apiKey: String)(page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, since: Option[OffsetDateTime] = None, before: Option[OffsetDateTime] = None, inboxId: Option[UUID] = None
): Request[Either[ResponseError[Exception], PageExpiredInboxRecordProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/expired?page=${ page }&size=${ size }&sort=${ sort }&since=${ since }&before=${ before }&inboxId=${ inboxId }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
