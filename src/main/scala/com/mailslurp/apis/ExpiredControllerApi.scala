...
import com.mailslurp.modelspackageVersion&#x3D;14.0.1.ExpirationDefaults
import com.mailslurp.modelspackageVersion&#x3D;14.0.1.ExpiredInboxDto
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;14.0.1.PageExpiredInboxRecordProjection
...
class ExpiredControllerApi(baseUrl: String) {
   ...
   */
  def getExpiredInboxes(apiKey: String)(before: Option[OffsetDateTime] = None, page: Option[Int] = None, since: Option[OffsetDateTime] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageExpiredInboxRecordProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/expired?before=${ before }&page=${ page }&since=${ since }&size=${ size }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
