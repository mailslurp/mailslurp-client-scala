...
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.EmailIntelligenceListResult
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.EmailIntelligenceOptions
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.PageEmailValidationRequest
import java.util.UUID
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.ValidateEmailAddressListOptions
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.ValidateEmailAddressListResult
...
class EmailVerificationControllerApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : EmailIntelligenceListResult (OK)
   * 
   * Available security schemes:
   *   API_KEY (apiKey)
   * 
   ...
   */
  def getEmailIntelligence(apiKey: String)(emailIntelligenceOptions: EmailIntelligenceOptions
): Request[Either[ResponseError[Exception], EmailIntelligenceListResult], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/email-verification/intelligence")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .body(emailIntelligenceOptions)
      .response(asJson[EmailIntelligenceListResult])
