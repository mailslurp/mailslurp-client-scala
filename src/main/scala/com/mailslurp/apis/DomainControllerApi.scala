...
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.CreateDomainOptions
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.DomainDto
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.DomainGroupsDto
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.DomainIssuesDto
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.DomainPreview
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.DomainRegionGroupsDto
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.InboxDto
import java.util.UUID
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.UpdateDomainOptions
...
class DomainControllerApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : DomainRegionGroupsDto (OK)
   * 
   * Available security schemes:
   *   API_KEY (apiKey)
   * 
   * @param inboxType 
   */
  def getAvailableDomainRegions(apiKey: String)(inboxType: Option[String] = None
): Request[Either[ResponseError[Exception], DomainRegionGroupsDto], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/domains/available-domain-regions?inboxType=${ inboxType }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[DomainRegionGroupsDto])
