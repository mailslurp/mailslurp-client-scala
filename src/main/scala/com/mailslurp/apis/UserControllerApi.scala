...
import com.mailslurp.modelspackageVersion&#x3D;17.1.0.CreateInboxRetentionPolicyForAccountOptions
import com.mailslurp.modelspackageVersion&#x3D;17.1.0.EmptyResponseDto
import com.mailslurp.modelspackageVersion&#x3D;17.1.0.InboxRetentionPolicyDto
import com.mailslurp.modelspackageVersion&#x3D;17.1.0.InboxRetentionPolicyOptionalDto
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;17.1.0.PageEntityAutomationItems
import com.mailslurp.modelspackageVersion&#x3D;17.1.0.PageEntityEventItems
import com.mailslurp.modelspackageVersion&#x3D;17.1.0.PageEntityFavouriteItems
import java.util.UUID
import com.mailslurp.modelspackageVersion&#x3D;17.1.0.UserInfoDto
...
class UserControllerApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : InboxRetentionPolicyDto (OK)
   * 
   ...
   */
  def createOrUpdateInboxRetentionPolicyForAccount(apiKey: String)(createInboxRetentionPolicyForAccountOptions: CreateInboxRetentionPolicyForAccountOptions
): Request[Either[ResponseError[Exception], InboxRetentionPolicyDto], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/user/inbox-retention-policies/account")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .body(createInboxRetentionPolicyForAccountOptions)
      .response(asJson[InboxRetentionPolicyDto])
   ...
   *   API_KEY (apiKey)
   */
  def deleteInboxRetentionPolicyForAccount(apiKey: String)(
): Request[Either[ResponseError[Exception], EmptyResponseDto], Nothing] =
    basicRequest
      .method(Method.DELETE, uri"$baseUrl/user/inbox-retention-policies/account")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   * 
   * Expected answers:
   *   code 200 : InboxRetentionPolicyOptionalDto (OK)
   * 
   * Available security schemes:
   *   API_KEY (apiKey)
   */
  def getInboxRetentionPolicyForAccount(apiKey: String)(
): Request[Either[ResponseError[Exception], InboxRetentionPolicyOptionalDto], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/user/inbox-retention-policies/account")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[InboxRetentionPolicyOptionalDto])
