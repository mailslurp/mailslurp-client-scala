...
import com.mailslurp.modelspackageVersion&#x3D;15.0.5.BulkSendEmailOptions
...
def apply(baseUrl: String = "http://localhost:8080") = new BulkActionsControllerApi(baseUrl)
}
