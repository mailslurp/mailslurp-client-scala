...
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.AttachmentMetaData
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.ByteArray
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.CanSendEmailResults
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.CheckEmailBodyFeatureSupportResults
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.CheckEmailBodyResults
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.CheckEmailClientSupportOptions
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.CheckEmailClientSupportResults
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.ContentMatchOptions
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.CountDto
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.DownloadAttachmentDto
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.Email
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.EmailContentMatchResult
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.EmailContentPartResult
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.EmailHtmlDto
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.EmailLinksResult
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.EmailPreview
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.EmailPreviewUrls
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.EmailScreenshotResult
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.EmailTextLinesResult
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.EmailThreadDto
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.EmailThreadItemsDto
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.ForwardEmailOptions
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.GetEmailScreenshotOptions
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.GravatarUrl
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.ImapFlagOperationOptions
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.PageEmailProjection
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.PageEmailThreadProjection
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.RawEmailJson
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.ReplyToEmailOptions
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.SearchEmailsOptions
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.SendEmailOptions
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.SentEmailDto
import java.util.UUID
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.UnreadCount
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.ValidationDto
...
class EmailControllerApi(baseUrl: String) {
   ...
   */
  def getEmailsOffsetPaginated(apiKey: String)(inboxId: Seq[UUID], page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, unreadOnly: Option[Boolean] = None, searchFilter: Option[String] = None, since: Option[OffsetDateTime] = None, before: Option[OffsetDateTime] = None, favourited: Option[Boolean] = None, syncConnectors: Option[Boolean] = None, plusAddressId: Option[UUID] = None
): Request[Either[ResponseError[Exception], PageEmailProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/emails/offset-paginated?inboxId=${ inboxId }&page=${ page }&size=${ size }&sort=${ sort }&unreadOnly=${ unreadOnly }&searchFilter=${ searchFilter }&since=${ since }&before=${ before }&favourited=${ favourited }&syncConnectors=${ syncConnectors }&plusAddressId=${ plusAddressId }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
