...
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.AttachmentMetaData
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.ByteArray
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.ContentMatchOptions
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.CountDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.DownloadAttachmentDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.Email
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.EmailContentMatchResult
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.EmailLinksResult
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.EmailPreview
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.EmailTextLinesResult
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.ForwardEmailOptions
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.GravatarUrl
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.PageEmailProjection
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.RawEmailJson
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.ReplyToEmailOptions
...
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.UnreadCount
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.ValidationDto
...
class EmailControllerApi(baseUrl: String) {
   ...
   */
  def sendEmailSourceOptional(apiKey: String)(inboxId: UUID, sendEmailOptions: SendEmailOptions, useDomainPool: Option[Boolean] = None
): Request[Either[ResponseError[Exception], Unit], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/emails?useDomainPool=${ useDomainPool }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
