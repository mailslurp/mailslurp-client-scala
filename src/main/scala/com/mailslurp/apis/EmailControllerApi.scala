...
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.AttachmentMetaData
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.ByteArray
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.CanSendEmailResults
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.CheckEmailBodyFeatureSupportResults
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.CheckEmailBodyResults
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.CheckEmailClientSupportOptions
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.CheckEmailClientSupportResults
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.ContentMatchOptions
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.CountDto
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.DownloadAttachmentDto
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.Email
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.EmailContentMatchResult
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.EmailContentPartResult
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.EmailHtmlDto
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.EmailLinksResult
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.EmailPreview
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.EmailPreviewUrls
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.EmailScreenshotResult
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.EmailTextLinesResult
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.ForwardEmailOptions
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.GetEmailScreenshotOptions
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.GravatarUrl
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.ImapFlagOperationOptions
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.PageEmailProjection
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.RawEmailJson
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.ReplyToEmailOptions
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.SearchEmailsOptions
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.SendEmailOptions
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.SentEmailDto
import java.util.UUID
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.UnreadCount
import com.mailslurp.modelspackageVersion&#x3D;15.19.20.ValidationDto
...
class EmailControllerApi(baseUrl: String) {
   ...
   */
  def getEmailContentPart(apiKey: String)(emailId: UUID, contentType: String
): Request[Either[ResponseError[Exception], EmailContentPartResult], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/emails/${emailId}/contentPart?contentType=${ contentType }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   */
  def getEmailHTML(apiKey: String)(emailId: UUID, decode: Option[Boolean] = None, replaceCidImages: Option[Boolean] = None
): Request[Either[ResponseError[Exception], String], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/emails/${emailId}/html?decode=${ decode }&replaceCidImages=${ replaceCidImages }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[String])
   ...
   * @param replaceCidImages 
   */
  def getEmailHTMLJson(apiKey: String)(emailId: UUID, decode: Option[Boolean] = None, replaceCidImages: Option[Boolean] = None
): Request[Either[ResponseError[Exception], EmailHtmlDto], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/emails/${emailId}/html/json?decode=${ decode }&replaceCidImages=${ replaceCidImages }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   */
  def getEmailsOffsetPaginated(apiKey: String)(inboxId: Seq[UUID], page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, unreadOnly: Option[Boolean] = None, searchFilter: Option[String] = None, since: Option[OffsetDateTime] = None, before: Option[OffsetDateTime] = None
): Request[Either[ResponseError[Exception], PageEmailProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/emails/offset-paginated?inboxId=${ inboxId }&page=${ page }&size=${ size }&sort=${ sort }&unreadOnly=${ unreadOnly }&searchFilter=${ searchFilter }&since=${ since }&before=${ before }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   */
  def searchEmails(apiKey: String)(searchEmailsOptions: SearchEmailsOptions
): Request[Either[ResponseError[Exception], PageEmailProjection], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/emails/search")
      .contentType("application/json")
      .header("x-api-key", apiKey)
