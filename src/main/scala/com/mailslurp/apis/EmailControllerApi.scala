...
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.AttachmentMetaData
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.ByteArray
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.ContentMatchOptions
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.CountDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.DownloadAttachmentDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.Email
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.EmailContentMatchResult
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.EmailLinksResult
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.EmailPreview
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.EmailTextLinesResult
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.ForwardEmailOptions
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.GravatarUrl
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.PageEmailProjection
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.RawEmailJson
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.ReplyToEmailOptions
...
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.UnreadCount
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.ValidationDto
...
class EmailControllerApi(baseUrl: String) {
   ...
   */
  def getEmailsPaginated(apiKey: String)(before: Option[OffsetDateTime] = None, inboxId: Seq[UUID], page: Option[Int] = None, searchFilter: Option[String] = None, since: Option[OffsetDateTime] = None, size: Option[Int] = None, sort: Option[String] = None, unreadOnly: Option[Boolean] = None
): Request[Either[ResponseError[Exception], PageEmailProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/emails?before=${ before }&inboxId=${ inboxId }&page=${ page }&searchFilter=${ searchFilter }&since=${ since }&size=${ size }&sort=${ sort }&unreadOnly=${ unreadOnly }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   * @param unreadOnly Optional filter for unread emails only. All emails are considered unread until they are viewed in the dashboard or requested directly
   */
  def getOrganizationEmailsPaginated(apiKey: String)(before: Option[OffsetDateTime] = None, inboxId: Seq[UUID], page: Option[Int] = None, searchFilter: Option[String] = None, since: Option[OffsetDateTime] = None, size: Option[Int] = None, sort: Option[String] = None, unreadOnly: Option[Boolean] = None
): Request[Either[ResponseError[Exception], PageEmailProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/emails/organization?before=${ before }&inboxId=${ inboxId }&page=${ page }&searchFilter=${ searchFilter }&since=${ since }&size=${ size }&sort=${ sort }&unreadOnly=${ unreadOnly }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[PageEmailProjection])
   ...
   */
  def sendEmailSourceOptional(apiKey: String)(inboxId: Option[UUID] = None, useDomainPool: Option[Boolean] = None, sendEmailOptions: Option[SendEmailOptions] = None
): Request[Either[ResponseError[Exception], Unit], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/emails?inboxId=${ inboxId }&useDomainPool=${ useDomainPool }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
