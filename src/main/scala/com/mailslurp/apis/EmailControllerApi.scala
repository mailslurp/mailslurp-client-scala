...
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.AttachmentMetaData
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.ByteArray
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.ContentMatchOptions
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.DownloadAttachmentDto
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.Email
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.EmailContentMatchResult
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.EmailLinksResult
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.EmailPreview
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.EmailTextLinesResult
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.ForwardEmailOptions
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.GravatarUrl
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.PageEmailProjection
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.RawEmailJson
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.ReplyToEmailOptions
...
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.UnreadCount
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.ValidationDto
...
class EmailControllerApi(baseUrl: String) {
   ...
   */
  def getEmailsPaginated(apiKey: String)(inboxId: Seq[UUID], page: Option[Int] = None, searchFilter: Option[String] = None, size: Option[Int] = None, sort: Option[String] = None, unreadOnly: Option[Boolean] = None
): Request[Either[ResponseError[Exception], PageEmailProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/emails?inboxId=${ inboxId }&page=${ page }&searchFilter=${ searchFilter }&size=${ size }&sort=${ sort }&unreadOnly=${ unreadOnly }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   * @param unreadOnly Optional filter for unread emails only. All emails are considered unread until they are viewed in the dashboard or requested directly
   */
  def getOrganizationEmailsPaginated(apiKey: String)(inboxId: Seq[UUID], page: Option[Int] = None, searchFilter: Option[String] = None, size: Option[Int] = None, sort: Option[String] = None, unreadOnly: Option[Boolean] = None
): Request[Either[ResponseError[Exception], PageEmailProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/emails/organization?inboxId=${ inboxId }&page=${ page }&searchFilter=${ searchFilter }&size=${ size }&sort=${ sort }&unreadOnly=${ unreadOnly }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[PageEmailProjection])
