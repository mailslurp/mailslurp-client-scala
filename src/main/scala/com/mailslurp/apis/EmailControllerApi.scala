...
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.AttachmentMetaData
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.ByteArray
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.ContentMatchOptions
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.CountDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.DownloadAttachmentDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.Email
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.EmailContentMatchResult
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.EmailLinksResult
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.EmailPreview
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.EmailTextLinesResult
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.ForwardEmailOptions
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.GravatarUrl
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.PageEmailProjection
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.RawEmailJson
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.ReplyToEmailOptions
...
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.UnreadCount
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.ValidationDto
...
def apply(baseUrl: String = "http://localhost:8080") = new EmailControllerApi(baseUrl)
}
...
class EmailControllerApi(baseUrl: String) {
   ...
   * @param emailId ID of email
   */
  def getAttachments(apiKey: String)(emailId: UUID
   ...
   */
  def getLatestEmail(apiKey: String)(inboxIds: Set[UUID]
): Request[Either[ResponseError[Exception], Email], Nothing] =
    basicRequest
   ...
   */
  def getLatestEmailInInbox(apiKey: String)(inboxId: UUID
): Request[Either[ResponseError[Exception], Email], Nothing] =
    basicRequest
   ...
   */
  def sendEmailSourceOptional(apiKey: String)(sendEmailOptions: SendEmailOptions, inboxId: Option[UUID] = None, useDomainPool: Option[Boolean] = None
): Request[Either[ResponseError[Exception], Unit], Nothing] =
    basicRequest
