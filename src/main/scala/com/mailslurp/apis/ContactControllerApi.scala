...
import com.mailslurp.modelspackageVersion&#x3D;15.0.2.ContactDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.2.ContactProjection
import com.mailslurp.modelspackageVersion&#x3D;15.0.2.CreateContactOptions
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.0.2.PageContactProjection
...
class ContactControllerApi(baseUrl: String) {
   ...
   */
  def getAllContacts(apiKey: String)(before: Option[OffsetDateTime] = None, page: Option[Int] = None, since: Option[OffsetDateTime] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageContactProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/contacts/paginated?before=${ before }&page=${ page }&since=${ since }&size=${ size }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
