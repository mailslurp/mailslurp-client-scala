...
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.ContactDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.ContactProjection
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.CreateContactOptions
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.0.4.PageContactProjection
...
def apply(baseUrl: String = "http://localhost:8080") = new ContactControllerApi(baseUrl)
}
...
class ContactControllerApi(baseUrl: String) {
   ...
   */
  def getAllContacts(apiKey: String)(page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, since: Option[OffsetDateTime] = None, before: Option[OffsetDateTime] = None
): Request[Either[ResponseError[Exception], PageContactProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/contacts/paginated?page=${ page }&size=${ size }&sort=${ sort }&since=${ since }&before=${ before }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
