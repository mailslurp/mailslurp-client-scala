...
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.CreateInboxForwarderOptions
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.InboxForwarderDto
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.InboxForwarderEventDto
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.InboxForwarderTestOptions
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.InboxForwarderTestResult
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.PageInboxForwarderDto
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.PageInboxForwarderEvents
import com.mailslurp.modelspackageVersion&#x3D;15.20.0.TestNewInboxForwarderOptions
...
class InboxForwarderControllerApi(baseUrl: String) {
   ...
   */
  def getAllInboxForwarderEvents(apiKey: String)(page: Option[Int] = None, size: Option[Int] = None, inboxId: Option[UUID] = None, emailId: Option[UUID] = None, sentId: Option[UUID] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageInboxForwarderEvents], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/forwarders/events?page=${ page }&size=${ size }&inboxId=${ inboxId }&emailId=${ emailId }&sentId=${ sentId }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   * 
   * Expected answers:
   *   code 200 : InboxForwarderEventDto (OK)
   * 
   * Available security schemes:
   *   API_KEY (apiKey)
   * 
   ...
   */
  def getForwarderEvent(apiKey: String)(eventId: UUID
): Request[Either[ResponseError[Exception], InboxForwarderEventDto], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/forwarders/events/${eventId}")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[InboxForwarderEventDto])
   ...
   * @param eventId ID of inbox forwarder event
   */
  def getInboxForwarderEvent(apiKey: String)(id: UUID, eventId: UUID
): Request[Either[ResponseError[Exception], InboxForwarderEventDto], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/forwarders/${id}/events/${eventId}")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[InboxForwarderEventDto])
