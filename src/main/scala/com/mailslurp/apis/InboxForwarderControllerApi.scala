...
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.CreateInboxForwarderOptions
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.InboxForwarderDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.InboxForwarderTestOptions
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.InboxForwarderTestResult
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.PageInboxForwarderDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.TestNewInboxForwarderOptions
...
class InboxForwarderControllerApi(baseUrl: String) {
   ...
   */
  def getInboxForwarders(apiKey: String)(before: Option[OffsetDateTime] = None, inboxId: Option[UUID] = None, page: Option[Int] = None, searchFilter: Option[String] = None, since: Option[OffsetDateTime] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageInboxForwarderDto], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/forwarders?before=${ before }&inboxId=${ inboxId }&page=${ page }&searchFilter=${ searchFilter }&since=${ since }&size=${ size }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
