...
import com.mailslurp.modelspackageVersion&#x3D;15.19.13.CreateInboxForwarderOptions
import com.mailslurp.modelspackageVersion&#x3D;15.19.13.InboxForwarderDto
import com.mailslurp.modelspackageVersion&#x3D;15.19.13.InboxForwarderEventDto
import com.mailslurp.modelspackageVersion&#x3D;15.19.13.InboxForwarderTestOptions
import com.mailslurp.modelspackageVersion&#x3D;15.19.13.InboxForwarderTestResult
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.19.13.PageInboxForwarderDto
import com.mailslurp.modelspackageVersion&#x3D;15.19.13.PageInboxForwarderEvents
import com.mailslurp.modelspackageVersion&#x3D;15.19.13.TestNewInboxForwarderOptions
...
class InboxForwarderControllerApi(baseUrl: String) {
   ...
   */
  def getAllInboxForwarderEvents(apiKey: String)(page: Option[Int] = None, size: Option[Int] = None, inboxId: Option[UUID] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageInboxForwarderEvents], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/forwarders/events?page=${ page }&size=${ size }&inboxId=${ inboxId }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
