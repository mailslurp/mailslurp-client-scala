...
import com.mailslurp.modelspackageVersion&#x3D;15.17.31.CreateInboxForwarderOptions
import com.mailslurp.modelspackageVersion&#x3D;15.17.31.InboxForwarderDto
import com.mailslurp.modelspackageVersion&#x3D;15.17.31.InboxForwarderEventDto
import com.mailslurp.modelspackageVersion&#x3D;15.17.31.InboxForwarderTestOptions
import com.mailslurp.modelspackageVersion&#x3D;15.17.31.InboxForwarderTestResult
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.17.31.PageInboxForwarderDto
import com.mailslurp.modelspackageVersion&#x3D;15.17.31.PageInboxForwarderEvents
import com.mailslurp.modelspackageVersion&#x3D;15.17.31.TestNewInboxForwarderOptions
...
class InboxForwarderControllerApi(baseUrl: String) {
   ...
   */
  def getAllInboxForwarderEvents(apiKey: String)(page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageInboxForwarderEvents], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/forwarders/events?page=${ page }&size=${ size }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
