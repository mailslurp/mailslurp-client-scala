...
import com.mailslurp.modelspackageVersion&#x3D;15.0.5.AttachmentEntity
...
import com.mailslurp.modelspackageVersion&#x3D;15.0.5.InlineObject
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.0.5.PageAttachmentEntity
import com.mailslurp.modelspackageVersion&#x3D;15.0.5.UploadAttachmentOptions
...
def apply(baseUrl: String = "http://localhost:8080") = new AttachmentControllerApi(baseUrl)
}
...
class AttachmentControllerApi(baseUrl: String) {
   ...
   */
  def getAttachments1(apiKey: String)(page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, fileNameFilter: Option[String] = None, since: Option[OffsetDateTime] = None, before: Option[OffsetDateTime] = None
