...
import com.mailslurp.modelspackageVersion&#x3D;17.3.0.AttachmentEntityDto
...
import com.mailslurp.modelspackageVersion&#x3D;17.3.0.ExtractAttachmentTextOptions
import com.mailslurp.modelspackageVersion&#x3D;17.3.0.ExtractAttachmentTextResult
import com.mailslurp.modelspackageVersion&#x3D;17.3.0.InlineObject1
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;17.3.0.PageAttachmentEntity
import java.util.UUID
import com.mailslurp.modelspackageVersion&#x3D;17.3.0.UploadAttachmentOptions
...
class AttachmentControllerApi(baseUrl: String) {
   ...
   * 
   * Expected answers:
   *   code 200 : ExtractAttachmentTextResult (OK)
   * 
   * Available security schemes:
   *   API_KEY (apiKey)
   * 
   * @param attachmentId ID of attachment
   * @param extractAttachmentTextOptions 
   */
  def extractAttachmentText(apiKey: String)(attachmentId: String, extractAttachmentTextOptions: Option[ExtractAttachmentTextOptions] = None
): Request[Either[ResponseError[Exception], ExtractAttachmentTextResult], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/attachments/${attachmentId}/text")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .body(extractAttachmentTextOptions)
      .response(asJson[ExtractAttachmentTextResult])

  /**
   * Expected answers:
   *   code 200 : AttachmentEntityDto (OK)
   * 
   * Available security schemes:
   *   API_KEY (apiKey)
   * 
...
): Request[Either[ResponseError[Exception], AttachmentEntityDto], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/attachments/${attachmentId}")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[AttachmentEntityDto])
   ...
   */
  def getAttachments(apiKey: String)(page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, fileNameFilter: Option[String] = None, since: Option[OffsetDateTime] = None, before: Option[OffsetDateTime] = None, inboxId: Option[UUID] = None, emailId: Option[UUID] = None, sentEmailId: Option[UUID] = None, include: Seq[String]
): Request[Either[ResponseError[Exception], PageAttachmentEntity], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/attachments?page=${ page }&size=${ size }&sort=${ sort }&fileNameFilter=${ fileNameFilter }&since=${ since }&before=${ before }&inboxId=${ inboxId }&emailId=${ emailId }&sentEmailId=${ sentEmailId }&include=${ include }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   * @param filename2 
   */
  def uploadAttachmentBytes(apiKey: String)(contentType: Option[String] = None, contentType2: Option[String] = None, contentId: Option[String] = None, filename: Option[String] = None, fileSize: Option[Long] = None, filename2: Option[String] = None
): Request[Either[ResponseError[Exception], Seq[String]], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/attachments/bytes?contentType=${ contentType2 }&contentId=${ contentId }&filename=${ filename }&fileSize=${ fileSize }")
      .contentType("application/json")
   ...
   * @param inlineObject1 
   */
  def uploadMultipartForm(apiKey: String)(contentId: Option[String] = None, contentType: Option[String] = None, filename: Option[String] = None, contentTypeHeader: Option[String] = None, xFilename: Option[String] = None, xFilenameRaw: Option[String] = None, xFilesize: Option[Long] = None, inlineObject1: Option[InlineObject1] = None
): Request[Either[ResponseError[Exception], Seq[String]], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/attachments/multipart?contentId=${ contentId }&contentType=${ contentType }&filename=${ filename }&contentTypeHeader=${ contentTypeHeader }&x-filename=${ xFilename }&x-filename-raw=${ xFilenameRaw }&x-filesize=${ xFilesize }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .body(inlineObject1)
      .response(asJson[Seq[String]])
