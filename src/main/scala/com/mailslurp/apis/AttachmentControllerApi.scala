...
import com.mailslurp.modelspackageVersion&#x3D;17.4.0.AttachmentEntityDto
...
import com.mailslurp.modelspackageVersion&#x3D;17.4.0.ExtractAttachmentTextOptions
import com.mailslurp.modelspackageVersion&#x3D;17.4.0.ExtractAttachmentTextResult
import com.mailslurp.modelspackageVersion&#x3D;17.4.0.InlineObject2
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;17.4.0.PageAttachmentEntity
import java.util.UUID
import com.mailslurp.modelspackageVersion&#x3D;17.4.0.UploadAttachmentOptions
...
class AttachmentControllerApi(baseUrl: String) {
   ...
   * @param inlineObject2 
   */
  def uploadMultipartForm(apiKey: String)(contentId: Option[String] = None, contentType: Option[String] = None, filename: Option[String] = None, contentTypeHeader: Option[String] = None, xFilename: Option[String] = None, xFilenameRaw: Option[String] = None, xFilesize: Option[Long] = None, inlineObject2: Option[InlineObject2] = None
): Request[Either[ResponseError[Exception], Seq[String]], Nothing] =
    basicRequest
