...
import com.mailslurp.modelspackageVersion&#x3D;15.21.0.AttachmentEntityDto
...
import com.mailslurp.modelspackageVersion&#x3D;15.21.0.InlineObject
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.21.0.PageAttachmentEntity
import java.util.UUID
import com.mailslurp.modelspackageVersion&#x3D;15.21.0.UploadAttachmentOptions
...
class AttachmentControllerApi(baseUrl: String) {
   ...
   */
  def getAttachments(apiKey: String)(page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, fileNameFilter: Option[String] = None, since: Option[OffsetDateTime] = None, before: Option[OffsetDateTime] = None, inboxId: Option[UUID] = None, emailId: Option[UUID] = None, sentEmailId: Option[UUID] = None
): Request[Either[ResponseError[Exception], PageAttachmentEntity], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/attachments?page=${ page }&size=${ size }&sort=${ sort }&fileNameFilter=${ fileNameFilter }&since=${ since }&before=${ before }&inboxId=${ inboxId }&emailId=${ emailId }&sentEmailId=${ sentEmailId }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   * @param inlineObject 
   */
  def uploadMultipartForm(apiKey: String)(contentId: Option[String] = None, contentType: Option[String] = None, filename: Option[String] = None, contentTypeHeader: Option[String] = None, xFilename: Option[String] = None, xFilenameRaw: Option[String] = None, xFilesize: Option[Long] = None, inlineObject: Option[InlineObject] = None
): Request[Either[ResponseError[Exception], Seq[String]], Nothing] =
    basicRequest
