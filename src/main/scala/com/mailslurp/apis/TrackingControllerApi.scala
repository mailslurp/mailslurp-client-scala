...
import com.mailslurp.modelspackageVersion&#x3D;12.6.0.CreateTrackingPixelOptions
import com.mailslurp.modelspackageVersion&#x3D;12.6.0.PageTrackingPixelProjection
import com.mailslurp.modelspackageVersion&#x3D;12.6.0.TrackingPixelDto
...
class TrackingControllerApi(baseUrl: String) {
   ...
   */
  def getAllTrackingPixels(apiKey: String)(page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageTrackingPixelProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/tracking/pixels?page=${ page }&size=${ size }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
