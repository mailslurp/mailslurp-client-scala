...
import com.mailslurp.modelspackageVersion&#x3D;14.0.6.CreateTemplateOptions
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;14.0.6.PageTemplateProjection
import com.mailslurp.modelspackageVersion&#x3D;14.0.6.TemplateDto
import com.mailslurp.modelspackageVersion&#x3D;14.0.6.TemplateProjection
...
class TemplateControllerApi(baseUrl: String) {
   ...
   */
  def getAllTemplates(apiKey: String)(before: Option[OffsetDateTime] = None, page: Option[Int] = None, since: Option[OffsetDateTime] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageTemplateProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/templates/paginated?before=${ before }&page=${ page }&since=${ since }&size=${ size }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
