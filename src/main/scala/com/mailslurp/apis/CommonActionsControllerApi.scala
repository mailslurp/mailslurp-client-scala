...
import com.mailslurp.modelspackageVersion&#x3D;15.0.5.SimpleSendEmailOptions
...
def apply(baseUrl: String = "http://localhost:8080") = new CommonActionsControllerApi(baseUrl)
}
...
class CommonActionsControllerApi(baseUrl: String) {
   ...
   * @param favourite 
   */
  def createNewEmailAddress(apiKey: String)(allowTeamAccess: Option[Boolean] = None, useDomainPool: Option[Boolean] = None, expiresAt: Option[OffsetDateTime] = None, expiresIn: Option[Long] = None, emailAddress: Option[String] = None, inboxType: Option[String] = None, description: Option[String] = None, name: Option[String] = None, tags: Set[String], favourite: Option[Boolean] = None
