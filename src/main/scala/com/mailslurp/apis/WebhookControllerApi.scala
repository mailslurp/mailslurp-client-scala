...
import com.mailslurp.modelspackageVersion&#x3D;14.0.0.AbstractWebhookPayload
import com.mailslurp.modelspackageVersion&#x3D;14.0.0.CreateWebhookOptions
import com.mailslurp.modelspackageVersion&#x3D;14.0.0.JSONSchemaDto
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;14.0.0.PageWebhookProjection
import com.mailslurp.modelspackageVersion&#x3D;14.0.0.PageWebhookResult
import java.util.UUID
import com.mailslurp.modelspackageVersion&#x3D;14.0.0.WebhookDto
import com.mailslurp.modelspackageVersion&#x3D;14.0.0.WebhookEmailOpenedPayload
import com.mailslurp.modelspackageVersion&#x3D;14.0.0.WebhookEmailReadPayload
import com.mailslurp.modelspackageVersion&#x3D;14.0.0.WebhookNewAttachmentPayload
import com.mailslurp.modelspackageVersion&#x3D;14.0.0.WebhookNewContactPayload
import com.mailslurp.modelspackageVersion&#x3D;14.0.0.WebhookNewEmailPayload
import com.mailslurp.modelspackageVersion&#x3D;14.0.0.WebhookRedriveResult
import com.mailslurp.modelspackageVersion&#x3D;14.0.0.WebhookResultDto
import com.mailslurp.modelspackageVersion&#x3D;14.0.0.WebhookTestResult
...
class WebhookControllerApi(baseUrl: String) {
   ...
   */
  def getAllWebhookResults(apiKey: String)(before: Option[OffsetDateTime] = None, page: Option[Int] = None, searchFilter: Option[String] = None, since: Option[OffsetDateTime] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageWebhookResult], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/webhooks/results?before=${ before }&page=${ page }&searchFilter=${ searchFilter }&since=${ since }&size=${ size }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   * @param sort Optional createdAt sort direction ASC or DESC
   */
  def getWebhookResults(apiKey: String)(webhookId: UUID, before: Option[OffsetDateTime] = None, page: Option[Int] = None, searchFilter: Option[String] = None, since: Option[OffsetDateTime] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageWebhookResult], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/webhooks/${webhookId}/results?before=${ before }&page=${ page }&searchFilter=${ searchFilter }&since=${ since }&size=${ size }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[PageWebhookResult])
