...
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.AbstractWebhookPayload
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.CountDto
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.CreateWebhookOptions
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.JSONSchemaDto
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.PageWebhookEndpointProjection
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.PageWebhookProjection
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.PageWebhookResult
import java.util.UUID
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.UnseenErrorCountDto
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.VerifyWebhookSignatureOptions
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.VerifyWebhookSignatureResults
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.WebhookBouncePayload
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.WebhookBounceRecipientPayload
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.WebhookDeliveryStatusPayload
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.WebhookDto
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.WebhookEmailOpenedPayload
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.WebhookEmailReadPayload
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.WebhookHeaders
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.WebhookNewAITransformResultPayload
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.WebhookNewAttachmentPayload
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.WebhookNewContactPayload
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.WebhookNewEmailPayload
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.WebhookNewSmsPayload
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.WebhookProjection
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.WebhookRedriveAllResult
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.WebhookRedriveResult
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.WebhookResultDto
import com.mailslurp.modelspackageVersion&#x3D;16.2.4.WebhookTestResult
...
class WebhookControllerApi(baseUrl: String) {
  ...
  def getAllWebhooks(apiKey: String)(page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, searchFilter: Option[String] = None, since: Option[OffsetDateTime] = None, inboxId: Option[UUID] = None, phoneId: Option[UUID] = None, before: Option[OffsetDateTime] = None, health: Option[String] = None, eventType: Option[String] = None, url: Option[String] = None
    ...
    basicRequest
      .method(Method.GET, uri"$baseUrl/webhooks/paginated?page=${ page }&size=${ size }&sort=${ sort }&searchFilter=${ searchFilter }&since=${ since }&inboxId=${ inboxId }&phoneId=${ phoneId }&before=${ before }&health=${ health }&eventType=${ eventType }&url=${ url }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[PageWebhookProjection])
   ...
   * @param overrideAuth 
   */
  def updateWebhook(apiKey: String)(webhookId: UUID, createWebhookOptions: CreateWebhookOptions, inboxId: Option[UUID] = None, phoneNumberId: Option[UUID] = None, overrideAuth: Option[Boolean] = None
): Request[Either[ResponseError[Exception], WebhookDto], Nothing] =
    basicRequest
      .method(Method.PATCH, uri"$baseUrl/webhooks/${webhookId}?inboxId=${ inboxId }&phoneNumberId=${ phoneNumberId }&overrideAuth=${ overrideAuth }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .body(createWebhookOptions)
      .response(asJson[WebhookDto])
