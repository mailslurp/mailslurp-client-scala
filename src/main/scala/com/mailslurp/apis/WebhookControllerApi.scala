...
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.AbstractWebhookPayload
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.CountDto
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.CreateWebhookOptions
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.JSONSchemaDto
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.PageWebhookEndpointProjection
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.PageWebhookProjection
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.PageWebhookResult
import java.util.UUID
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.UnseenErrorCountDto
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.VerifyWebhookSignatureOptions
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.VerifyWebhookSignatureResults
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.WebhookBouncePayload
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.WebhookBounceRecipientPayload
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.WebhookDeliveryStatusPayload
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.WebhookDto
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.WebhookEmailOpenedPayload
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.WebhookEmailReadPayload
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.WebhookHeaders
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.WebhookNewAITransformResultPayload
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.WebhookNewAttachmentPayload
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.WebhookNewContactPayload
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.WebhookNewEmailPayload
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.WebhookNewSmsPayload
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.WebhookProjection
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.WebhookRedriveAllResult
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.WebhookRedriveResult
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.WebhookResultDto
import com.mailslurp.modelspackageVersion&#x3D;17.0.0.WebhookTestResult
...
class WebhookControllerApi(baseUrl: String) {
   ...
   * @param eventType Optional event type
   */
  def getInboxWebhooksPaginated(apiKey: String)(inboxId: UUID, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, searchFilter: Option[String] = None, since: Option[OffsetDateTime] = None, before: Option[OffsetDateTime] = None, health: Option[String] = None, eventType: Option[String] = None
): Request[Either[ResponseError[Exception], PageWebhookProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/inboxes/${inboxId}/webhooks/paginated?page=${ page }&size=${ size }&sort=${ sort }&searchFilter=${ searchFilter }&since=${ since }&before=${ before }&health=${ health }&eventType=${ eventType }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[PageWebhookProjection])
   ...
   * @param health Filter by webhook health
   */
  def getPhoneNumberWebhooksPaginated(apiKey: String)(phoneId: UUID, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, since: Option[OffsetDateTime] = None, before: Option[OffsetDateTime] = None, eventType: Option[String] = None, searchFilter: Option[String] = None, health: Option[String] = None
): Request[Either[ResponseError[Exception], PageWebhookProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/phone/numbers/${phoneId}/webhooks/paginated?page=${ page }&size=${ size }&sort=${ sort }&since=${ since }&before=${ before }&eventType=${ eventType }&searchFilter=${ searchFilter }&health=${ health }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[PageWebhookProjection])
