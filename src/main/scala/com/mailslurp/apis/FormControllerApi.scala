...
class FormControllerApi(baseUrl: String) {
   ...
   */
  def submitForm(apiKey: String)(emailAddress: Option[String] = None, redirectTo: Option[String] = None, spamCheck: Option[String] = None, subject: Option[String] = None, successMessage: Option[String] = None, to: Option[String] = None, otherParameters: Option[String] = None
): Request[Either[ResponseError[Exception], String], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/forms")
      .contentType("multipart/form-data")
      .header("x-api-key", apiKey)
      .multipartBody(Seq(
                emailAddress.map(multipart("_emailAddress", _))
, 
                redirectTo.map(multipart("_redirectTo", _))
, 
                spamCheck.map(multipart("_spamCheck", _))
, 
                subject.map(multipart("_subject", _))
, 
                successMessage.map(multipart("_successMessage", _))
, 
                to.map(multipart("_to", _))
, 
                otherParameters.map(multipart("otherParameters", _))
