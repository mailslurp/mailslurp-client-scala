...
class FormControllerApi(baseUrl: String) {
   ...
   */
  def submitForm(apiKey: String)(to: Option[String] = None, subject: Option[String] = None, emailAddress: Option[String] = None, successMessage: Option[String] = None, spamCheck: Option[String] = None, otherParameters: Option[String] = None
