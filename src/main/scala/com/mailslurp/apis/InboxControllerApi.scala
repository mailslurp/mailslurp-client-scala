...
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.CreateInboxDto
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.CreateInboxRulesetOptions
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.EmailPreview
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.Inbox
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.InboxRulesetDto
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.PageEmailPreview
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.PageInboxProjection
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.PageInboxRulesetDto
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.PageOrganizationInboxProjection
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.PageSentEmailProjection
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.PageTrackingPixelProjection
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.SendEmailOptions
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.SentEmailDto
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.SetInboxFavouritedOptions
import java.util.UUID
import com.mailslurp.modelspackageVersion&#x3D;13.1.0.UpdateInboxOptions
...
class InboxControllerApi(baseUrl: String) {
   ...
   */
  def getEmails(apiKey: String)(inboxId: UUID, delayTimeout: Option[Long] = None, limit: Option[Int] = None, minCount: Option[Long] = None, retryTimeout: Option[Long] = None, since: Option[OffsetDateTime] = None, size: Option[Int] = None, sort: Option[String] = None, unreadOnly: Option[Boolean] = None
): Request[Either[ResponseError[Exception], Seq[EmailPreview]], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/inboxes/${inboxId}/emails?delayTimeout=${ delayTimeout }&limit=${ limit }&minCount=${ minCount }&retryTimeout=${ retryTimeout }&since=${ since }&size=${ size }&sort=${ sort }&unreadOnly=${ unreadOnly }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   * @param sort Optional createdAt sort direction ASC or DESC
   */
  def getInboxSentEmails(apiKey: String)(inboxId: UUID, page: Option[Int] = None, searchFilter: Option[String] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageSentEmailProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/inboxes/${inboxId}/sent?page=${ page }&searchFilter=${ searchFilter }&size=${ size }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   * @param sort Optional createdAt sort direction ASC or DESC
   */
  def getOrganizationInboxes(apiKey: String)(page: Option[Int] = None, searchFilter: Option[String] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageOrganizationInboxProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/inboxes/organization?page=${ page }&searchFilter=${ searchFilter }&size=${ size }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   * @param sort Optional createdAt sort direction ASC or DESC
   */
  def listInboxRulesets(apiKey: String)(inboxId: UUID, page: Option[Int] = None, searchFilter: Option[String] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageInboxRulesetDto], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/inboxes/${inboxId}/rulesets?page=${ page }&searchFilter=${ searchFilter }&size=${ size }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   * @param sort Optional createdAt sort direction ASC or DESC
   */
  def listInboxTrackingPixels(apiKey: String)(inboxId: UUID, page: Option[Int] = None, searchFilter: Option[String] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageTrackingPixelProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/inboxes/${inboxId}/tracking-pixels?page=${ page }&searchFilter=${ searchFilter }&size=${ size }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
