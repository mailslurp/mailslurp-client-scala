...
import com.mailslurp.modelspackageVersion&#x3D;12.5.0.CreateInboxDto
import com.mailslurp.modelspackageVersion&#x3D;12.5.0.CreateInboxRulesetOptions
import com.mailslurp.modelspackageVersion&#x3D;12.5.0.EmailPreview
import com.mailslurp.modelspackageVersion&#x3D;12.5.0.Inbox
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;12.5.0.PageEmailPreview
import com.mailslurp.modelspackageVersion&#x3D;12.5.0.PageInboxProjection
import com.mailslurp.modelspackageVersion&#x3D;12.5.0.PageOrganizationInboxProjection
import com.mailslurp.modelspackageVersion&#x3D;12.5.0.PageSentEmailProjection
import com.mailslurp.modelspackageVersion&#x3D;12.5.0.SendEmailOptions
import com.mailslurp.modelspackageVersion&#x3D;12.5.0.SentEmailDto
import com.mailslurp.modelspackageVersion&#x3D;12.5.0.SetInboxFavouritedOptions
import java.util.UUID
import com.mailslurp.modelspackageVersion&#x3D;12.5.0.UpdateInboxOptions
...
class InboxControllerApi(baseUrl: String) {
   ...
   * @param sort Optional createdAt sort direction ASC or DESC
   */
  def listInboxRulesets(apiKey: String)(inboxId: UUID, page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], Unit], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/inboxes/${inboxId}/rulesets?page=${ page }&size=${ size }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[Unit])
