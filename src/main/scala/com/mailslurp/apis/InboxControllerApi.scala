...
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.CreateInboxDto
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.CreateRulesetOptions
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.Email
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.EmailAvailableResult
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.EmailPreview
import java.io.File
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.FlushExpiredInboxesResult
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.ImapAccessDetails
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.ImapSmtpAccessDetails
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.ImapSmtpAccessServers
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.ImportEmailOptions
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.InboxByEmailAddressResult
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.InboxByNameResult
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.InboxDto
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.InboxExistsDto
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.InboxIdsResult
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.PageDeliveryStatus
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.PageEmailPreview
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.PageInboxProjection
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.PageInboxTags
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.PageOrganizationInboxProjection
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.PagePlusAddressProjection
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.PageRulesetDto
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.PageScheduledJobs
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.PageSentEmailProjection
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.PageTrackingPixelProjection
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.PlusAddressDto
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.RulesetDto
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.ScheduledJobDto
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.SearchInboxesOptions
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.SendEmailOptions
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.SendSMTPEnvelopeOptions
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.SentEmailDto
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.SetInboxFavouritedOptions
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.SmtpAccessDetails
import java.util.UUID
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.UpdateImapAccessOptions
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.UpdateInboxOptions
import com.mailslurp.modelspackageVersion&#x3D;17.5.0.UpdateSmtpAccessOptions
...
class InboxControllerApi(baseUrl: String) {
   ...
   */
  def createInboxRuleset(apiKey: String)(inboxId: UUID, createRulesetOptions: CreateRulesetOptions
   ...
   * @param search Optionally filter by search words partial matching name and email address
   ...
   */
  def getOrCreateInboxPlusAddress(apiKey: String)(inboxId: UUID, fullAddress: String
): Request[Either[ResponseError[Exception], PlusAddressDto], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/inboxes/${inboxId}/plus-addresses/get-or-create?fullAddress=${ fullAddress }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[PlusAddressDto])
   ...
   * @param fullAddress Full recipient address including +suffix. Example: `inbox+alias@domain.com`
   */
  def getOrCreatePlusAddressByFullAddress(apiKey: String)(fullAddress: String
): Request[Either[ResponseError[Exception], PlusAddressDto], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/inboxes/get-or-create-plus-address?fullAddress=${ fullAddress }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[PlusAddressDto])
   ...
   */
  def importEmailIntoInbox(apiKey: String)(inboxId: UUID, importEmailOptions: ImportEmailOptions
): Request[Either[ResponseError[Exception], Email], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/inboxes/${inboxId}/emails/import")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .body(importEmailOptions)
      .response(asJson[Email])
   ...
   * @param externalId 
   * @param runPipeline 
   * @param overrideMessageId 
   */
  def importEmailIntoInboxBytes(apiKey: String)(inboxId: UUID, body: ByteArray, externalId: Option[String] = None, runPipeline: Option[Boolean] = None, overrideMessageId: Option[Boolean] = None
): Request[Either[ResponseError[Exception], Email], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/inboxes/${inboxId}/emails/import/raw?externalId=${ externalId }&runPipeline=${ runPipeline }&overrideMessageId=${ overrideMessageId }")
   ...
   * @param overrideMessageId 
   */
  def importEmailIntoInboxMultipart(apiKey: String)(inboxId: UUID, file: File, externalId: Option[String] = None, runPipeline: Option[Boolean] = None, overrideMessageId: Option[Boolean] = None
): Request[Either[ResponseError[Exception], Email], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/inboxes/${inboxId}/emails/import/multipart?externalId=${ externalId }&runPipeline=${ runPipeline }&overrideMessageId=${ overrideMessageId }")
