...
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.CountDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.CreateInboxDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.CreateInboxRulesetOptions
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.EmailPreview
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.FlushExpiredInboxesResult
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.Inbox
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.InboxExistsDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.InboxRulesetDto
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.PageEmailPreview
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.PageInboxProjection
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.PageInboxRulesetDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.PageOrganizationInboxProjection
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.PageSentEmailProjection
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.PageTrackingPixelProjection
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.SendEmailOptions
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.SentEmailDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.SetInboxFavouritedOptions
import java.util.UUID
import com.mailslurp.modelspackageVersion&#x3D;15.0.3.UpdateInboxOptions
...
class InboxControllerApi(baseUrl: String) {
   ...
   */
  def createInbox(apiKey: String)(allowTeamAccess: Option[Boolean] = None, description: Option[String] = None, emailAddress: Option[String] = None, expiresAt: Option[OffsetDateTime] = None, expiresIn: Option[Long] = None, favourite: Option[Boolean] = None, inboxType: Option[String] = None, name: Option[String] = None, tags: Seq[String], useDomainPool: Option[Boolean] = None
): Request[Either[ResponseError[Exception], Inbox], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/inboxes?allowTeamAccess=${ allowTeamAccess }&description=${ description }&emailAddress=${ emailAddress }&expiresAt=${ expiresAt }&expiresIn=${ expiresIn }&favourite=${ favourite }&inboxType=${ inboxType }&name=${ name }&tags=${ tags }&useDomainPool=${ useDomainPool }")
   ...
   */
  def getAllInboxes(apiKey: String)(before: Option[OffsetDateTime] = None, favourite: Option[Boolean] = None, page: Option[Int] = None, search: Option[String] = None, since: Option[OffsetDateTime] = None, size: Option[Int] = None, sort: Option[String] = None, tag: Option[String] = None, teamAccess: Option[Boolean] = None
): Request[Either[ResponseError[Exception], PageInboxProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/inboxes/paginated?before=${ before }&favourite=${ favourite }&page=${ page }&search=${ search }&since=${ since }&size=${ size }&sort=${ sort }&tag=${ tag }&teamAccess=${ teamAccess }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   */
  def getEmails(apiKey: String)(inboxId: UUID, before: Option[OffsetDateTime] = None, delayTimeout: Option[Long] = None, limit: Option[Int] = None, minCount: Option[Long] = None, retryTimeout: Option[Long] = None, since: Option[OffsetDateTime] = None, size: Option[Int] = None, sort: Option[String] = None, unreadOnly: Option[Boolean] = None
): Request[Either[ResponseError[Exception], Seq[EmailPreview]], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/inboxes/${inboxId}/emails?before=${ before }&delayTimeout=${ delayTimeout }&limit=${ limit }&minCount=${ minCount }&retryTimeout=${ retryTimeout }&since=${ since }&size=${ size }&sort=${ sort }&unreadOnly=${ unreadOnly }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   * @param sort Optional createdAt sort direction ASC or DESC
   */
  def getInboxEmailsPaginated(apiKey: String)(inboxId: UUID, before: Option[OffsetDateTime] = None, page: Option[Int] = None, since: Option[OffsetDateTime] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageEmailPreview], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/inboxes/${inboxId}/emails/paginated?before=${ before }&page=${ page }&since=${ since }&size=${ size }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   * @param sort Optional createdAt sort direction ASC or DESC
   */
  def getInboxSentEmails(apiKey: String)(inboxId: UUID, before: Option[OffsetDateTime] = None, page: Option[Int] = None, searchFilter: Option[String] = None, since: Option[OffsetDateTime] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageSentEmailProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/inboxes/${inboxId}/sent?before=${ before }&page=${ page }&searchFilter=${ searchFilter }&since=${ since }&size=${ size }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   * @param sort Optional createdAt sort direction ASC or DESC
   */
  def getInboxes(apiKey: String)(before: Option[OffsetDateTime] = None, since: Option[OffsetDateTime] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], Seq[Inbox]], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/inboxes?before=${ before }&since=${ since }&size=${ size }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   * @param sort Optional createdAt sort direction ASC or DESC
   */
  def getOrganizationInboxes(apiKey: String)(before: Option[OffsetDateTime] = None, page: Option[Int] = None, searchFilter: Option[String] = None, since: Option[OffsetDateTime] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageOrganizationInboxProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/inboxes/organization?before=${ before }&page=${ page }&searchFilter=${ searchFilter }&since=${ since }&size=${ size }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   * @param sort Optional createdAt sort direction ASC or DESC
   */
  def listInboxRulesets(apiKey: String)(inboxId: UUID, before: Option[OffsetDateTime] = None, page: Option[Int] = None, searchFilter: Option[String] = None, since: Option[OffsetDateTime] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageInboxRulesetDto], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/inboxes/${inboxId}/rulesets?before=${ before }&page=${ page }&searchFilter=${ searchFilter }&since=${ since }&size=${ size }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   * @param sort Optional createdAt sort direction ASC or DESC
   */
  def listInboxTrackingPixels(apiKey: String)(inboxId: UUID, before: Option[OffsetDateTime] = None, page: Option[Int] = None, searchFilter: Option[String] = None, since: Option[OffsetDateTime] = None, size: Option[Int] = None, sort: Option[String] = None
): Request[Either[ResponseError[Exception], PageTrackingPixelProjection], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/inboxes/${inboxId}/tracking-pixels?before=${ before }&page=${ page }&searchFilter=${ searchFilter }&since=${ since }&size=${ size }&sort=${ sort }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
