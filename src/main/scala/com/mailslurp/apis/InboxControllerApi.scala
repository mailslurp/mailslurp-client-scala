...
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.CountDto
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.CreateInboxDto
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.CreateInboxRulesetOptions
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.Email
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.EmailPreview
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.FlushExpiredInboxesResult
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.ImapSmtpAccessDetails
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.InboxByEmailAddressResult
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.InboxByNameResult
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.InboxDto
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.InboxExistsDto
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.InboxIdsResult
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.InboxRulesetDto
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.PageDeliveryStatus
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.PageEmailPreview
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.PageInboxProjection
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.PageInboxRulesetDto
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.PageOrganizationInboxProjection
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.PageScheduledJobs
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.PageSentEmailProjection
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.PageTrackingPixelProjection
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.ScheduledJobDto
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.SendEmailOptions
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.SendSMTPEnvelopeOptions
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.SentEmailDto
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.SetInboxFavouritedOptions
import java.util.UUID
import com.mailslurp.modelspackageVersion&#x3D;15.16.21.UpdateInboxOptions
...
class InboxControllerApi(baseUrl: String) {
   ...
   */
  def createInbox(apiKey: String)(emailAddress: Option[String] = None, tags: Seq[String], name: Option[String] = None, description: Option[String] = None, useDomainPool: Option[Boolean] = None, favourite: Option[Boolean] = None, expiresAt: Option[OffsetDateTime] = None, expiresIn: Option[Long] = None, allowTeamAccess: Option[Boolean] = None, inboxType: Option[String] = None, virtualInbox: Option[Boolean] = None, useShortAddress: Option[Boolean] = None
): Request[Either[ResponseError[Exception], InboxDto], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/inboxes?emailAddress=${ emailAddress }&tags=${ tags }&name=${ name }&description=${ description }&useDomainPool=${ useDomainPool }&favourite=${ favourite }&expiresAt=${ expiresAt }&expiresIn=${ expiresIn }&allowTeamAccess=${ allowTeamAccess }&inboxType=${ inboxType }&virtualInbox=${ virtualInbox }&useShortAddress=${ useShortAddress }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
