...
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.CountDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.CreateInboxDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.CreateInboxRulesetOptions
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.EmailPreview
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.FlushExpiredInboxesResult
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.InboxDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.InboxExistsDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.InboxRulesetDto
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.PageEmailPreview
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.PageInboxProjection
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.PageInboxRulesetDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.PageOrganizationInboxProjection
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.PageSentEmailProjection
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.PageTrackingPixelProjection
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.SendEmailOptions
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.SentEmailDto
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.Set
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.SetInboxFavouritedOptions
import java.util.UUID
import com.mailslurp.modelspackageVersion&#x3D;15.0.7.UpdateInboxOptions
...
class InboxControllerApi(baseUrl: String) {
   ...
   */
  def createInbox(apiKey: String)(emailAddress: Option[String] = None, tags: Seq[String], name: Option[String] = None, description: Option[String] = None, useDomainPool: Option[Boolean] = None, favourite: Option[Boolean] = None, expiresAt: Option[OffsetDateTime] = None, expiresIn: Option[Long] = None, allowTeamAccess: Option[Boolean] = None, inboxType: Option[String] = None
): Request[Either[ResponseError[Exception], InboxDto], Nothing] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/inboxes?emailAddress=${ emailAddress }&tags=${ tags }&name=${ name }&description=${ description }&useDomainPool=${ useDomainPool }&favourite=${ favourite }&expiresAt=${ expiresAt }&expiresIn=${ expiresIn }&allowTeamAccess=${ allowTeamAccess }&inboxType=${ inboxType }")
