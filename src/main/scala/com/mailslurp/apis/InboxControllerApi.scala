...
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.CreateInboxDto
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.CreateInboxRulesetOptions
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.Email
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.EmailAvailableResult
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.EmailPreview
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.FlushExpiredInboxesResult
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.ImapAccessDetails
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.ImapSmtpAccessDetails
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.ImapSmtpAccessServers
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.InboxByEmailAddressResult
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.InboxByNameResult
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.InboxDto
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.InboxExistsDto
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.InboxIdsResult
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.InboxRulesetDto
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.PageDeliveryStatus
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.PageEmailPreview
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.PageInboxProjection
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.PageInboxRulesetDto
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.PageOrganizationInboxProjection
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.PageScheduledJobs
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.PageSentEmailProjection
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.PageTrackingPixelProjection
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.ScheduledJobDto
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.SearchInboxesOptions
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.SendEmailOptions
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.SendSMTPEnvelopeOptions
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.SentEmailDto
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.SetInboxFavouritedOptions
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.SmtpAccessDetails
import java.util.UUID
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.UpdateImapAccessOptions
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.UpdateInboxOptions
import com.mailslurp.modelspackageVersion&#x3D;15.19.22.UpdateSmtpAccessOptions
...
class InboxControllerApi(baseUrl: String) {
   ...
   * @param allowCatchAll 
   */
  def doesInboxExist(apiKey: String)(emailAddress: String, allowCatchAll: Option[Boolean] = None
): Request[Either[ResponseError[Exception], InboxExistsDto], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/inboxes/exists?emailAddress=${ emailAddress }&allowCatchAll=${ allowCatchAll }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   */
  def getAllScheduledJobs(apiKey: String)(page: Option[Int] = None, size: Option[Int] = None, sort: Option[String] = None, since: Option[OffsetDateTime] = None, before: Option[OffsetDateTime] = None
): Request[Either[ResponseError[Exception], PageScheduledJobs], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/inboxes/scheduled-jobs?page=${ page }&size=${ size }&sort=${ sort }&since=${ since }&before=${ before }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
   ...
   * @param before Optional filter by created before given date time
   */
  def getInboxes(apiKey: String)(size: Option[Int] = None, sort: Option[String] = None, since: Option[OffsetDateTime] = None, excludeCatchAllInboxes: Option[Boolean] = None, before: Option[OffsetDateTime] = None
): Request[Either[ResponseError[Exception], Seq[InboxDto]], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/inboxes?size=${ size }&sort=${ sort }&since=${ since }&excludeCatchAllInboxes=${ excludeCatchAllInboxes }&before=${ before }")
      .contentType("application/json")
      .header("x-api-key", apiKey)
