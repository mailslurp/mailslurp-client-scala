...
import com.mailslurp.modelspackageVersion&#x3D;15.12.16.DeliveryStatus
import com.mailslurp.modelspackageVersion&#x3D;15.12.16.EmailPreviewUrls
import java.time.OffsetDateTime
import com.mailslurp.modelspackageVersion&#x3D;15.12.16.PageDeliveryStatus
import com.mailslurp.modelspackageVersion&#x3D;15.12.16.PageSentEmailProjection
import com.mailslurp.modelspackageVersion&#x3D;15.12.16.PageSentEmailWithQueueProjection
...
): Request[Either[ResponseError[Exception], DeliveryStatus], Nothing] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/sent/delivery-status/${deliveryId}")
      .contentType("application/json")
      .header("x-api-key", apiKey)
      .response(asJson[DeliveryStatus])
