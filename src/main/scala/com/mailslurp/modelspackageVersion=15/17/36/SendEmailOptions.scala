 ...
 */
package com.mailslurp.modelspackageVersion&#x3D;15.17.36
...
case class SendEmailOptions(
  ...
  validateEmailAddresses: Option[SendEmailOptionsEnums.ValidateEmailAddresses] = None,
  /* Ignore empty recipients after validation removes all recipients as invalid and fail silently */
  ignoreEmptyRecipients: Option[Boolean] = None,
  ...
  bodyParts: Option[Seq[SendEmailBodyPart]] = None
)

object SendEmailOptionsEnums {

  type SendStrategy = SendStrategy.Value
  type ValidateEmailAddresses = ValidateEmailAddresses.Value
  object SendStrategy extends Enumeration {
    val SINGLEMESSAGE = Value("SINGLE_MESSAGE")
  }

  object ValidateEmailAddresses extends Enumeration {
    val VALIDATEFILTERREMOVEINVALID = Value("VALIDATE_FILTER_REMOVE_INVALID")
    val VALIDATEERRORIFINVALID = Value("VALIDATE_ERROR_IF_INVALID")
    val NOVALIDATION = Value("NO_VALIDATION")
  }
