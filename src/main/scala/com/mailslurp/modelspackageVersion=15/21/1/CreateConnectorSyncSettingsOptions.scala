...
package com.mailslurp.modelspackageVersion&#x3D;15.21.1
   ...
   */
case class CreateConnectorSyncSettingsOptions(
  /* Enable automatic background sync */
  syncEnabled: Option[Boolean] = None,
  /* Sync schedule type */
  syncScheduleType: Option[CreateConnectorSyncSettingsOptionsEnums.SyncScheduleType] = None,
  /* Sync interval in minutes */
  syncInterval: Option[Int] = None
)

object CreateConnectorSyncSettingsOptionsEnums {
