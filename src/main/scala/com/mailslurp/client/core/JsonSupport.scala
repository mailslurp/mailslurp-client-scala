...
import com.mailslurp.modelspackageVersion&#x3D;12.5.0._
import org.json4s._
...
object JsonSupport extends SttpJson4sApi {
  def enumSerializers: Seq[Serializer[_]] = Seq[Serializer[_]]() :+
    ...
    new EnumNameSerializer(InboxRulesetProjectionEnums.Action) :+
    new EnumNameSerializer(InboxRulesetProjectionEnums.Handler) :+
    new EnumNameSerializer(InboxRulesetProjectionEnums.Scope) :+
