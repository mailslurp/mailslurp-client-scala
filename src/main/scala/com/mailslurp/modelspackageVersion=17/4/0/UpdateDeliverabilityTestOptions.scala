...
import java.time.OffsetDateTime
   ...
   */
case class UpdateDeliverabilityTestOptions(
  ...
  clearMaxDuration: Option[Boolean] = None,
  ...
  clearSuccessThreshold: Option[Boolean] = None,
  /* Optional replacement expectations */
  expectations: Option[Seq[DeliverabilityExpectation]] = None
)
