...
package com.mailslurp.modelspackageVersion&#x3D;17.4.0
   ...
   */
case class CheckDnsPropagationResults(
  host: String,
  /* Domain Name Server Record Types */
  recordType: CheckDnsPropagationResultsEnums.RecordType,
  expectedValue: Option[String] = None,
  propagatedToAllResolvers: Boolean,
  respondingResolverCount: Int,
  matchingResolverCount: Int,
  resolverResults: Seq[DnsPropagationResolverResult],
  warnings: Seq[String],
  errors: Seq[String]
)

object CheckDnsPropagationResultsEnums {
