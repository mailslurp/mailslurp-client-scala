...
import java.util.UUID
   ...
   */
case class CreateInboxReplierOptions(
  ...
  field: Option[CreateInboxReplierOptionsEnums.Field] = None,
  ...
  should: Option[CreateInboxReplierOptionsEnums.Should] = None,
  matchOptions: Option[InboxAutomationMatchOptions] = None
)

object CreateInboxReplierOptionsEnums {
